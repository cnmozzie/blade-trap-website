<template>
  <div v-katex:auto class="container-fluid">
    <div class="row">
      ...
      <div class="col-12">
        <figcaption class="figure-caption text-center"><strong>Figure 3:</strong> A example of a lattice (a) and its dual-lattice (b).
      ...
      <div class="col-12">
        <figcaption class="figure-caption text-center"><strong>Figure 4:</strong> Toric code 2\(\times\)2 example. Qubits are denoted by number 1 to 8. 
