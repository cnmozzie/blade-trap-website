    ...
    <div class="row">
	  <div class="col-12">
		...
		<p>We create the toric code as follows. We embed a square lattice as an n edge graph \(\Gamma\) on 
		   a torus \(\mathbb{T}^{2}\) as in <a href="#fig1">Figure 1</a>. We then <em>assign a qubit to each of the n edges of the graph</em> 
		   so that we have a <em>2n dimensional Hilbert space</em> \(L=\otimes_{\text {edges }} \mathbb{C}^{2}\).</p>
	  </div>
	  <div class="col-center-block">  
        <img src="toric_code/torus-wire.png" width="460" height="254" id="fig1">
	  </div>
      <div class="col-12">
	  ...
	  <div class="col-12">
	    <p>Consider <a href="#fig2">Figure 2</a>. For each vertex v of the graph \(\Gamma\) (i.e. a point on the original square lattice) 
	  ...
	  <div class="col-center-block">  
        <embed src="toric_code/operator.svg" id="fig2">
	  </div>
      <div class="col-12">
      ...
      <div class="col-12">
		...
		<p>The toric code places qubits at every edge on our lattice, hence n = |edges|. But for the
		   ...
		   <div class="anchor" id="equation1"></div>
		...
		<p>Furthermore, it is clear that \(−I \notin S\). Thus by <a href="#theorem1">Theorem 1</a>, the Toric code must have a code space \(V_S\) of size 2 
		...
		<p>Suppose the qubits on the lattice embedded on the torus are in the ground state \(|\zeta\rangle\). Then
           ...
           \(E_0+2\) and creates an e-anyon pair at the boundary of such a path (See <a href="#fig3a">Figure 3(a)</a>). However, if we consider
	  ...
	  <div class="col-center-block">  
        <embed src="toric_code/lattice.svg" id="fig3a">
	  ...
	  <div class="col-center-block">  
        <embed src="toric_code/example.svg" id="fig4">
	  </div>
      <div class="col-12">
      ...
      <div class="col-12">
        <p>For <a href="#fig4">Figure 4</a>, the ground state is (up to a suitable normalization):
		   $$|\zeta\rangle=\left(I+A_{k}\right)\left(I+A_{\ell}\right)\left(I+A_{m}\right)\left(I+A_{n}\right)|00000000\rangle.$$
		   According to <a href="#equation1">equation 1</a>, we have \(A_kA_lA_mA_n=I\). Combined with the relation \(A_v^2=I\), we will have many other relations.
